...
function () {
  ...
  E.prototype.p = function (b) {
    ...
    if (!this.ghost && !g.playfield[b[0]][b[1]].path) {
      ...
      this.dir = 0
    } else this.lastGoodTilePos = [
      b[0],
      b[1]
    ];
    g.playfield[b[0]][b[1]].type == 1 &&
    this.mode != 8 ? this.c(2) : this.c(0);
    !this.ghost &&
    g.playfield[b[0]][b[1]].dot &&
  ...
  E.prototype.d = function () {
    switch (this.currentSpeed) {
      case 0:
        var b = this.id == g.playerCount &&
        (this.mode == 2 || this.mode == 1) ? g.cruiseElroySpeed : this.fullSpeed;
        break;
      case 1:
  ...
  E.prototype.r = function () {
    ...
    if (g.gameplayMode == 10 || g.gameplayMode == 4 || g.gameplayMode == 3) {
      ...
      45 ? 2 : 3 : g.cutsceneSequenceId == 2 ? 3 : g.cutsceneSequenceId == 3 ||
      g.cutsceneSequenceId == 4 ? 4 : 0;
      c = 13
    } else {
      c = this.nextDir;
  ...
  g.prepareElement = function (b, c, d) {
    ...
    if (g.useCss) {
      b.style.backgroundImage = 'url(images/pacman10-hp-sprite.png)';
  ...
  g.insertCoin = function () {
    g.gameplayMode == 8 ||
    g.gameplayMode == 14 ? g.newGame() : g.initiateDoubleMode()
  };
  ...
  g.changeGameplayMode = function (b) {
    ...
    switch (b) {
      ...
      case 8:
      case 14:
        window.parent.putScore('PacMan', g.score[0]);
  ...
  g.startCutscene = function () {
    ...
    for (var b in g.cutscene.actors) {
      ...
      c.pos = [
        g.cutscene.actors[b].y * 8,
        g.cutscene.actors[b].x * 8
      ];
      c.posDelta = [
        0,
        0
      ...
      if (g.gameplayModeTime <= 0) {
        ...
        switch (g.gameplayMode) {
          case 1:
            ...
            var c = e;
            for (b = g.playerCount; b < g.playerCount + 4; b++) if (
              g.actors[b].mode == 4 ||
  ...
  g.initializeTickTimer = function () {
    ...
    g.fps = C[g.fpsChoice];
    g.tickInterval = 1000 / g.fps;
    g.tickMultiplier = D / g.fps;
    g.timing = {};
    for (var b in w) {
      var c = !g.soundEnabled &&
      (b == 7 || b == 8) ? 1 : w[b];
  ...
  g.detectFlash = function () {
    ...
    if (navigator.plugins && navigator.plugins.length) {
      ...
      if (
        b = (d = navigator.mimeTypes['application/x-shockwave-flash']) &&
        d.enabledPlugin
      ) {
  ...
  g.prepareSound = function () {
    ...
    if (!g.hasFlash || !g.isFlashVersion('9.0.0.0')) {
      ...
      g.flashIframeDoc.write(
        '<html><head></head><body><object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="0" height="0" id="pacman-sound-player" type="application/x-shockwave-flash"> <param name="movie" value="sound/pacman10-hp-sound.swf"> <param name="allowScriptAccess" value="always"> <object id="pacman-sound-player-2"  type="application/x-shockwave-flash" data="sound/pacman10-hp-sound.swf" width="0" height="0"><param name="allowScriptAccess" value="always"> </object></object></body></html>'
      );
      g.flashIframeDoc.close();
      window.setTimeout(g.flashNotReady, 3000)
    }
  };
  ...
  g.init = function () {
    ...
    g.useCss = navigator.userAgent.indexOf('MSIE 5.') != - 1 ||
    navigator.userAgent.indexOf('MSIE 6.') != - 1 ||
    navigator.userAgent.indexOf('MSIE 7.') != - 1 ? e : a;
    g.prepareGraphics();
    g.prepareSound()
  };
  g.init();
