  ...
  function () {
    ...
    google.dom.get = function (a, b, c) {
      ...
      if (a) {
        ...
        var e = b;
        b = [];
        for (var f; f = e[d++]; ) a.test(f.className) &&
        b.push(f)
      }
      return b.length > 1 ||
      c ? b : b[0]
...
(
  function () {
    ...
    google.fx.animate = function (a, d, e) {
      ...
      f = f ||
      window.setInterval(i, 15)
    };
    function i() {
      for (var a = 0, d; d = g[a++]; ) j(d) ||
      g.splice(--a, 1);
      if (!g.length) {
...
(
  function () {
    ...
    function m(b, c, a) {
      for (var e = document.getElementsByTagName('a'), o = 0, h; h = e[o++]; ) b(h) &&
      google.bind(h, 'click', l(c, a))
    }
    function n() {
      if (!g.persisted) {
        g.persisted = true;
  ...
  function () {
    ...
    function Qa() {
      ...
      if (n) {
        ...
        a(
          '.gac_od',
          c + 'border-top:0;border-left:0;border-right:1px solid #e7e7e7;border-bottom:1px solid #e7e7e7;padding:0!important;position:absolute'
        );
        a(
          '.gac_id',
          c + 'border-top:1px solid #a2bff0;border-left:1px solid #a2bff0;border-right:1px solid #558be3;border-bottom:1px solid #558be3;display:block;position:relative'
        );
        a(
          '.gac_m',
          c + 'border:0;cursor:default;display:block;font-size:17px;line-height:117%;padding:0;position:relative'
        );
        if (!document.body.dir || document.body.dir == 'ltr') a(
          '.gac_wd',
      ...
      a(
        '.gac_u',
        'padding:0 0 1px 0;line-height:117%;text-align:left'
      );
      ...
      a(
        '.gac_bt',
        'width:' + (w.offsetWidth - 2) + 'px;text-align:center;padding:8px 0 7px;position:relative'
      );
    ...
    function Z(a, b) {
      if (b && b.value.length && a.length) return ['&',
      a,
      '=',
      b.value].join('');
      return ''
    ...
    function lb(a) {
      for (var b = 0, c; c = W(b++); ) if (za(c.m) == 'p' && c.j == a[0]) {
        ...
        c.v.innerHTML = 'This search was removed from your <a href="/history">Web History</a>'
      }
    }
    function mb(a) {
      function b(oa, Y) {
    ...
    function rb(a) {
      var b = a ? 'I&#39;m Feeling Lucky' : 'Google Search',
      c = 'gac_sb',
      d = '',
      e = '';
      if (n) {
    ...
    function $(a, b) {
      ...
      b,
      '\')" onclick="return google.ac.c(event)"'].join('')
    }
    function sb(a, b, c) {
      m = j;
    ...
    function La() {
      ...
      a.push(Bb);
      ea &&
      a.push(Cb, Db, Eb, Fb, Gb, Hb, Ib, Jb, Kb, Lb);
      Mb(a)
    }
    function Mb(a) {
    ...
    Ab = {
      ...
      e: function (a, b, c) {
        ...
        c.j = Ob(d);
        a.innerHTML = [
          '<span class=gac_z>Did you mean: </span>',
          b
        ].join('')
      }
    };
...
(
  function () {
    ...
    function v(a) {
      if (!a.e.l) {
        a.e.l = '<font color=red>Error:</font> The server could not complete your request.  Try again in 30 seconds.';
        a.G = a.a.onclick;
      ...
      if (!a.v) {
        ...
        a.H = b &&
        google.getPageOffsetStart(a.d) > google.getPageOffsetStart(b) + google.getWidth(b);
    ...
    function w() {
      d = {};
      g = {};
      history.navigationMode = history.navigationMode &&
      'fast'
    }
    w();
...
(
  function () {
    ...
    function u() {
      ...
      if (a) {
        a.open(
          'GET',
          [
            google.base_href.indexOf('/images?') == 0 ? google.base_href.replace(/^\/images\?/, '/mbd?') : google.base_href.replace(/^\/search\?/, '/mbd?'),
    ...
    function v(a) {
      for (var b = 0, c = 0, d, e; (d = a[b]) && (e = q[c]); b++, c++) if (google.Toolbelt.pti[c]) e.id != d[0] &&
      b--;
       else {
        if (d[2]) {
          e.className = 'tbos';
      ...
      if (!a.getAttribute('data-loaded')) {
        ...
        for (var e = 0, f = google.Toolbelt.atg.length; e < f; ++e) {
          ...
          for (var n; (n = google.Toolbelt.pbt[c]) && n[0] == e; c++) {
            ...
            b.push(
              '<li class="' + q[c].className + '" id=' + q[c].id + '>' + q[c].innerHTML
            )
          }
...
if (!window.gbar || !gbar.close) {
  ...
  (
    function () {
      ...
      k;
      function l(a) {
        var b = window.encodeURIComponent &&
        (document.forms[0].q || '').value;
        if (b) a.href = a.href.replace(
          /([?&])q=[^&]*|$/,
          function (c, d) {
      ...
      function n(a) {
        ...
        var c = a.getAttribute('aria-owns') ||
        'gbi',
        d = a.offsetWidth,
...
window.rwt = function (a, i, j, o, p, k, c, q) {
  try {
    ...
    escape,
    d = 0;
    if (!google.njr) for (var e = location.href.split('#'), l = 0; l < 2 && !d; l++) {
      d = e &&
      e[1] &&
      e[1].match('(^|&)q=(.*?)(&|$)');
...
(
  function () {
    ...
    google.rt.resume = function () {
      var a = ((new Date).getTime() - aa) / 1000;
      if (a > 10) i = [];
      y();
      z(y, h);
      fa(ga, 2000, 6000);
    ...
    function y() {
      if (p) {
        p = g;
        q = (new Date).getTime()
      } else if ((new Date).getTime() - q > 240000) return;
      t = s + 5 > r;
      if (!(j || t || !m)) {
        var a = google.xhr();
        a.open('GET', m);
    ...
    function Y(a, c) {
      ...
      var b = 70 * (c ? 1 : - 1);
      pa(a, b);
      for (var d = 0, e; e = a.childNodes[d++]; ) e.nodeType == 1 &&
      pa(e, b)
    }
    function pa(a, c) {
    ...
    function wa(a, c) {
      ...
      if (b < 86400) if (b < 45) return 'seconds ago';
        ...
        b = Math.floor(b / 3600) + (b % 3600 >= 3000 ? 1 : 0);
    ...
    function $(a) {
      var c = [];
      a = a.getElementsByTagName('span');
      for (var b = 0, d; d = a[b++]; ) d.className.match('rtd') &&
      c.push(d);
      return c
    }
    function ya(a) {
...
(
  function ggxjs29sk() {
    ...
    u[ka()] = 1;
    var v = 0;
    if (u.ie) if (document.documentMode) v = document.documentMode;
     else {
    ...
    P = function (a, b) {
      if (b || j.ss == j.m && ++N == M) if (google.timers && google.timers.load.t && google.timers.load.e) {
      ...
      try {
        ...
        L(
          'SCSI',
          {
            n: M,
            i: b,
            s: c ? typeof c.src == 'string' ? c.src.substr(0, 40) : 1 :
            0,
            c: c ? c.complete : 0
          },
          d
    ...
    function _trap() {
      for (var a = document.getElementsByTagName('form'), b = 0, c; c = a[b++]; ) G.test(c.action) &&
      !/\bnj\b/.test(c.className) &&
      wa(c, 'onsubmit', function (d) {
        return xa(this, i, d)
      })
    }
    j.trap = _trap;
    ...
    function ya(a, b) {
      delete E[a][b];
      if (l) {
        for (var c = a + b, d = p(a), e = - 1, g = 0, k; k = d[g++]; ) if (k == c) {
          e = g - 1;
          break
        }
        if (e >= 0) {
    ...
    function za(a, b) {
      for (var c = {}, d = [], e = b.length - 1; e >= 0; e--) if (!c[b[e]]) {
        c[b[e]] = 1;
        d.push(b[e])
      }
      d.reverse();
        ...
        try {
          ...
          if (b == 'main') {
            ...
            for (var x; x = [
              ...
              'bgs',
              'f'
            ][a++]; ) if (document[x]) document[x].q.value = q
          }
      ...
      if (s) {
        ...
        try {
          if (
            ...
            !(y.google && y.google.loc) &&
            b
          ) G.test(a) ? Pa(Fa()) : R(z, a, 1)
        } catch (d) {
          L('_l', {
          }, d)
        }
    ...
    function xa(a, b) {
      ...
      try {
        if (b) c += a.match(/\?(.*)/) [1];
          ...
          a.q &&
          a.q.blur();
          for (var e = 0, g; g = a.elements[e++]; ) if (!((g.type == 'radio' || g.type == 'submit') && !g.checked)) {
            if (g.name == 'btnI') return f;
            g.name &&
            d.push(g.name + '=' + encodeURIComponent(g.value))
          }
        ...
        if (!k) return i;
        if (
          /(^| )(r?phonebook|define|cache):/.test(k) ||
          /(\?|&)pb=(r|f)/.test(c) ||
          /(\?|&)swm=2/.test(c)
        ) return f
      } catch (q) {
    ...
    function Va() {
      ...
      if (!U('s', a)) try {
        ...
        for (var b = U('c', D), c = 0, d; d = b.co[c++]; ) Y('p', [
          d,
    ...
    function Ga(a) {
      return !a &&
      w == 1 ? cb() : z.hash ? z.href.substr(z.href.indexOf('#')) : '#'
    }
    function Sa(a, b, c) {
      b = new RegExp('([?&]' + b + '=).*?([&#]|$)');
    ...
    function Ma() {
      try {
        for (var a = $('q') || $('as_q') || ma, b = 0, c; c = [
          'gs',
          'bgs',
          'f'
        ][b++]; ) if (document[c]) document[c].q.value = a
      } catch (d) {
        L('PQ', {
        }, d)
      }
    ...
    function nb() {
      ...
      try {
        if (r) {
          ...
          u.ie &&
          google.bind(document, 'mousedown', jb);
          z.hash &&
          z.hash != '#' &&
          Z(D);
          var d = !ab();
